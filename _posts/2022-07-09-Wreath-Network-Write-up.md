...
![alt-10](multi_stager.png)

![alt-11](launcher_stager.png)
...
![alt-25](Pwr_Port_Scan_Result.png)
...
![alt-39](nc-upload.png)

![alt-40](nc-upload-proof.png)

![alt-41](l15t3nr-directory-check.png)
...
![alt-46](service-running.png)

Now to check if the directory is writable.

`powershell “get-acl –Path ‘C:\Program Files (x86)\System Explorer’ | format-list”`

![alt-47](Writable-directory.png)
...
![alt-49](PrivilegeEscalation.png)

![alt-50](AllThePrivs.png)
