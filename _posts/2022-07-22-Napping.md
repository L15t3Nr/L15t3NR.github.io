...
Napping can be found [here](/assets/img/Napping/https://tryhackme.com/room/nappingis1337)
...
The Welcome Page source reveals a known vulnerability with "target=\_blank" called Reverse Tab Nabbing. [HackTricks - Reverse Tab Nabbing](/assets/img/Napping/https://book.hacktricks.xyz/pentesting-web/reverse-tab-nabbing)
...
Adrian has the ability to run Vim as sudo without a password. [GTFObins](/assets/img/Napping/https://gtfobins.github.io/gtfobins/vim/) has a few ways to abuse this for a shell. 
